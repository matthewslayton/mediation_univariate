...
### (1) X~M is done in stamp_lavaan_multLevel_mar8.R

########## (2) Y~M ############
##### grab here to copy and paste
...
for (tbl in tbl_names) {
  for (mem in memType) {
    for (ROI_name in ROI_name_variable) {
      ...
      # 
      #need to mean-center correctedRecog_CRET and _PRET
      ...
      for (i in 1:how_many_fac) {
        ...
        # Fit the models
        model_included <- lm(formula_included, data = updated_data_mixed_clean)
        model_excluded <- lm(formula_excluded, data = updated_data_mixed_clean)
...
filename <- sprintf('/Users/matthewslayton/Library/CloudStorage/OneDrive-DukeUniversity/STAMP/medAnalysis_topFacFromY-M_mar12_nmf%d.xlsx',factorNumber)
...
#filename <- '/Users/matthewslayton/Library/CloudStorage/OneDrive-DukeUniversity/STAMP/medAnalysis_multilevel_unilateral_mariam_and_nmf.xlsx'
#filename <- sprintf('/Users/matthewslayton/Library/CloudStorage/OneDrive-DukeUniversity/STAMP/medAnalysis_mar5_nmf%d.xlsx',factorNumber)
filename <- sprintf('/Users/matthewslayton/Library/CloudStorage/OneDrive-DukeUniversity/STAMP/medAnalysis_topFacFromY_X_mult_M_mar12_nmf%d.xlsx',factorNumber)
write_xlsx(mediation_output_df, filename)
...
#filename <- '/Users/matthewslayton/Library/CloudStorage/OneDrive-DukeUniversity/STAMP/medAnalysis_multilevel_unilateral_mariam_and_nmf.xlsx'
#filename <- sprintf('/Users/matthewslayton/Library/CloudStorage/OneDrive-DukeUniversity/STAMP/medAnalysis_mar5_nmf%d.xlsx',factorNumber)
filename <- sprintf('/Users/matthewslayton/Library/CloudStorage/OneDrive-DukeUniversity/STAMP/medAnalysis_topFacFromY_X_plus_M_mar12_nmf%d.xlsx',factorNumber)
write_xlsx(mediation_output_df, filename)
